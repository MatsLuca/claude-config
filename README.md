...
| `/optimieren` | Einen Command, Agent oder Skill nach dem Authoring-Standard schärfen — mit Eval-Lauf vorher und nachher; ein fehlendes Runner-Szenario legt der Command selbst an |
