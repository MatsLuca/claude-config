...
allowed-tools: Bash(git add:*), Bash(git commit:*), Bash(git pull:*), Bash(git push:*), Bash(git rebase:*), Bash(git rev-parse:*), Bash(git status:*), Bash(git symbolic-ref:*), Bash(DEF=*)
---
